...
class ServiceMain2 extends StatefulWidget {
  const ServiceMain2({super.key});

  @override
  State<ServiceMain2> createState() => _ServiceMain2State();
}

var circleAvatar = const Padding(
...
class _ServiceMain2State extends State<ServiceMain2> {
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                const Padding(
                                  padding: EdgeInsets.only(top: 162, left: 132),
