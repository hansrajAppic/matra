...
class AstroLive1 extends StatefulWidget {
  const AstroLive1({super.key});

  @override
  State<AstroLive1> createState() => _AstroLive1State();
}

class _AstroLive1State extends State<AstroLive1> {
  @override
              ...
              children: [
                Padding(
                  ...
                  child: Stack(children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 67, left: 295),
